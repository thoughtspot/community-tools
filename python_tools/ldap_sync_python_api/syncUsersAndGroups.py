...
class ScriptArguments():
    ...
    sync_arguments = [
        ...
        Argument(
            flag="scope",
            help_str="Scope to limit the search to (choice number)\n"
            + "0:base Searching only the entry at the base DN\n"
            + "1:one Searching all entries one level under the base DN -"
            + " but not including the base DN\n"
            + "2:tree Searching of all entries at all levels under and"
            + " including the specified base DN",
        ),
        Argument(
